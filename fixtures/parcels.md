...
|---|---|---|---|---|---|
| **A** | `MZ544750899GB` | `8645991e-538a-40a2-8618-6f9d3777a6ae` | Tracked 24 | 2026-08-26, handed over 14:21Z | Delivered-path event stream; the damage photographs; the `gb-post` proof — ✅ **delivered 2026-08-28 13:49Z, seven events captured**: four `in_transit`, two `out_for_delivery`, then `delivered` |
